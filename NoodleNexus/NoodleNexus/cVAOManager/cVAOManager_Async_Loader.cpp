...
bool cVAOManager::LoadModelIntoVAO_Async(std::string fileName,
	...
	unsigned int shadowShaderProgramID)
{
...
void cVAOManager::LoadAsynModels(unsigned int shaderProgramID, unsigned int shadowShaderProgramID)
{
	...
	if (bFoundModelToCopyToVAO)
	{
		...
		this->m_CopyLoadedModelToVAO(meshToLoadToVAO, shadowShaderProgramID);
