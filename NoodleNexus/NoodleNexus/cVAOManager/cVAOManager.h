...
public:
	...
	//					   unsigned int shaderProgramID);
	bool LoadModelsIntoVAO(std::string basepath, std::vector<std::pair<std::string, bool>>& vecFileNames, unsigned int shaderProgramID, unsigned int shadowShaderProgramID);

	bool LoadModelIntoVAO(std::string fileName, std::string basepath, sModelDrawInfo& drawInfo, unsigned int shaderProgramID, unsigned int shadowShaderProgramID);

	bool LoadModelIntoVAO(std::string fileName, sModelDrawInfo& drawInfo, unsigned int shaderProgramID, unsigned int shadowShaderProgramID);
	...
	void LoadAsynModels(unsigned int shaderProgramID, unsigned int shadowShaderProgramID);

	bool LoadModelIntoVAO_Async(std::string fileName, sModelDrawInfo& drawInfo, unsigned int shaderProgramID, unsigned int shadowShaderProgramID);
